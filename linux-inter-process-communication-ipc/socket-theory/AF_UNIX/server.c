...
int main(int argc, char *argv[])
{
    ...
    /*This is the main loop for handling connection. */
    /*All seerver process usally runs 24 x 7. Good servers should always up and running and should never go down. Have you ever seen Facebook, Google page failed to load. */
    ...
    for(;;)
    {
        ...
        for(;;)
        {
            ...
            /*Server is blocked here. Waiting for the data to arrive from client. 'Read' is blocking system call*/
